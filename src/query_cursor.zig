...
const QueryMatch = extern struct {
    ...
    inline fn into(self: *QueryMatch) Query.Match {
        return .{
            .id = self.id,
...
pub const QueryCursor = opaque {
    ...
    pub inline fn setMaxStartDepth(self: *QueryCursor, max_start_depth: u32) void {
